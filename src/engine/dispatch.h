...
enum DivDispatchCmds {
  ...
  DIV_CMD_YAM10_FILTER_CUTOFF, // (value: index, value2: amount)
  DIV_CMD_YAM10_FILTER_RES, // (value: index, value2: amount)
  DIV_CMD_YAM10_FILTER_MODE, // (value: index, value2: amount)
  DIV_CMD_YAM10_FILTER_ENABLE, // (value: index, value2: amount)
  DIV_CMD_YAM10_DIST_GAIN, // (value: index, value2: amount)
  DIV_CMD_YAM10_DIST_LEVEL, // (value: index, value2: amount)
  DIV_CMD_YAM10_CHORUS_MIX, // (value: index, value2: amount)
  DIV_CMD_YAM10_CHORUS_RATE, // (value: index, value2: amount)
  DIV_CMD_YAM10_CHORUS_DEPTH, // (value: index, value2: amount)
  DIV_CMD_YAM10_ECHO_MIX, // (value: index, value2: amount)
  DIV_CMD_YAM10_ECHO_FB, // (value: index, value2: amount)
  DIV_CMD_YAM10_REVERB_MIX, // (value: amount)
  DIV_CMD_YAM10_REVERB_SEND, // (value: amount)
  DIV_CMD_YAM10_REVERB_DECAY, // (value: amount)
  DIV_CMD_YAM10_REVERB_EARLY, // (value: amount)
  DIV_CMD_YAM10_REVERB_DIFF, // (value: amount)
  DIV_CMD_YAM10_REVERB_SIZE, // (value: amount)
  DIV_CMD_YAM10_REVERB_DAMP, // (value: amount)
  DIV_CMD_YAM10_REVERB_EN, // (value: amount)
  DIV_CMD_YAM10_COMP_THR, // (value: amount)
  DIV_CMD_YAM10_COMP_DOWN, // (value: amount)
  DIV_CMD_YAM10_COMP_UP, // (value: amount)
  DIV_CMD_YAM10_COMP_ATK, // (value: amount)
  DIV_CMD_YAM10_COMP_DEC, // (value: amount)
  DIV_CMD_YAM10_COMP_XLO, // (value: amount)
  DIV_CMD_YAM10_COMP_XHI, // (value: amount)
  DIV_CMD_YAM10_COMP_GLO, // (value: amount)
  DIV_CMD_YAM10_COMP_GMID, // (value: amount)
  DIV_CMD_YAM10_COMP_GHI, // (value: amount)
  DIV_CMD_YAM10_COMP_OUT, // (value: amount)
  DIV_CMD_YAM10_COMP_EN, // (value: amount)
  DIV_CMD_YAM10_EQ_EN, // (value: amount)
  DIV_CMD_YAM10_PHASE_INV, // (value: amount)
  DIV_CMD_YAM10_EQ_SEL, // (value: amount)
  DIV_CMD_YAM10_EQ_FREQ, // (value: amount)
  DIV_CMD_YAM10_EQ_GAIN, // (value: amount)
  DIV_CMD_YAM10_EQ_Q, // (value: amount)
  DIV_CMD_YAM10_EQ_TYPE, // (value: amount)
  DIV_CMD_YAM10_EQ_ON, // (value: amount)
  DIV_CMD_YAM10_DIST_CUTOFF, // (value: amount)
  DIV_CMD_YAM10_DIST_EN, // (value: amount)
  DIV_CMD_YAM10_CHORUS_EN, // (value: amount)
  DIV_CMD_YAM10_CHORUS_FB, // (value: amount)
  DIV_CMD_YAM10_CHORUS_WIDTH, // (value: amount)
  DIV_CMD_YAM10_ECHO_DELAY, // (value: amount)
  DIV_CMD_YAM10_OP_OUTLVL, // (value: operator, value2: amount)
  DIV_CMD_YAM10_OP_PAN, // (value: operator, value2: amount)
  DIV_CMD_YAM10_OP_MODIN, // (value: operator, value2: mask)
